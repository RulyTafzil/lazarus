...
def build_spec() -> dict[str, Any]:
    ...
    return {
        ...
        "paths": {
            ...
            "/api/v1/threads/{id}/trash": {"post": {"summary": "Trash thread (+trash -inbox -unread + move to Trash)", "responses": {"200": {"description": "{status: ok, trashed: id, ok: true, count: int}"}}}},
            "/api/v1/threads/{id}/restore": {"post": {"summary": "Restore thread from Trash to INBOX", "responses": {"200": {"description": "{status: ok, restored: id, ok: true, count: int}"}}}},
            "/api/v1/threads/{id}/move-archive": {"post": {"summary": "Move thread files to local Archive", "responses": {"200": {"description": "{status: ok, archived: id, ok: true, count: int}"}}}},
            ...
            "/api/v1/messages/{id}/trash": {"post": {"summary": "Move message files to Trash", "parameters": [{"name": "id", "in": "path", "required": True, "schema": {"type": "string"}, "description": "RFC message ID"}, {"name": "thread_id", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "{status: ok, trashed: id, ok: true, count: int}"}}}},
            "/api/v1/messages/{id}/restore": {"post": {"summary": "Restore message files from Trash to INBOX", "parameters": [{"name": "id", "in": "path", "required": True, "schema": {"type": "string"}, "description": "RFC message ID"}, {"name": "thread_id", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "{status: ok, restored: id, ok: true, count: int}"}}}},
            "/api/v1/messages/{id}/move-archive": {"post": {"summary": "Move message files to local Archive", "parameters": [{"name": "id", "in": "path", "required": True, "schema": {"type": "string"}, "description": "RFC message ID"}, {"name": "thread_id", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "{status: ok, archived: id, ok: true, count: int}"}}}},
